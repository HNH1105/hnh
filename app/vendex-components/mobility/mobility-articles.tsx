...
import { Const_Home_Knowledge_Hub_Text } from "~/app/const";
export function ArticlesSection() {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl py-8  lg:py-16">
        <div className="mx-auto mb-8 text-left w-full lg:mb-16 ">
          <h2 className="mb-4 text-[15px] font-light tracking-tight text-gray-900 text-left w-full dark:text-white">
